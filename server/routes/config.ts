...
const DEFAULT_CONFIG = {
  ...
  faqs: [
    ...
    { q: 'What events are listed here?', a: 'Only in-person events organized by and run within Portugal\'s tech communities. Standalone events that aren\'t tied to a community aren\'t part of the curation, at least for now.' },
  ],
  notionFormUrl: '',
